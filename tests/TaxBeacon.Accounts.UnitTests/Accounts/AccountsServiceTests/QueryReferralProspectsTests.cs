...
{
    [Fact]
    public async Task QueryReferralProspects_ReturnsReferralProspectDto()
    {
        // Arrange
        ...
        var referrals = TestData.ReferralsViewFaker
            ...
            .RuleFor(a => a.ReferralState, f => ReferralState.ReferralProspect.Name)
            .Generate(3);
        ...
        using (new AssertionScope())
        {
            actualResult.Should().HaveCount(expectedReferrals.Count)
                .And.AllBeOfType<ReferralProspectDto>();
        }
    }

    [Fact]
    public async Task QueryReferralProspects_ReturnsSalespersonsField()
    {
        // Arrange
        ...
        var referrals = TestData.ReferralsFaker
                ...
                .RuleFor(a => a.State, f => ReferralState.ReferralProspect.Name)
                .Generate(5);
        ...
        // Act
        var actualResult = await _accountService.QueryReferralsProspects().ToListAsync();

...
namespace TaxBeacon.API.UnitTests.Controllers.Tenants;
...
public class TenantsControllerTests
{
    ...
    public void GetAssignedProgramsAsync_MarkedWithCorrectHasPermissionsAttribute()
    {
        ...
        {
            Common.Permissions.Tenants.Read, Common.Permissions.Tenants.ReadWrite,
    ...
    public void SwitchToTenantAsync_MarkedWithCorrectHasPermissionsAttribute()
    {
        ...
        var permissions = new object[] { Common.Permissions.Tenants.Switch, };

...
public class GlobalSearchService
{
    ...
    public void SearchIndexContainsAllFieldsFromIndexDefinition()
    {
        ...
        var definition = JsonSerializer.Deserialize<IndexDefinition>(json, new JsonSerializerOptions(JsonSerializerDefaults.Web));

        var fields = definition?.Fields.Select(f => f.Name).ToArray();
    ...
    public void SearchIndexContainsAllSearchableFieldsFromIndexDefinition()
    {
        ...
        var fields = definition?.Fields.Where(f => f.Searchable).Select(f => f.Name).ToArray();
